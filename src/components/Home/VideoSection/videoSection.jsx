    ...
    <section className="video-section">
      ...
      >
        ...
        <p className="left-text-content">
          Skip the hassle of endless listings and lowball offers. With Amacar,
          dealers compete to buy your car, giving you the best price quickly,
          securely, and stress-free—cash in hand, without compromise.
        </p>
        <button
