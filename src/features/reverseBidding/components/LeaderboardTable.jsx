...
export default function LeaderboardTable({ rows, onView, onAccept, timeRemaining = 0 }) {
    ...
    return (
        <div className="overflow-hidden rounded-2xl border border-neutral-200/50 bg-white shadow-lg">
            ...
            <div className="grid grid-cols-12 px-6 py-4 bg-gradient-to-r from-neutral-50 to-white border-b border-neutral-200">
                ...
                <div className="col-span-3 text-xs font-bold text-neutral-700 uppercase tracking-wider">Dealer</div>
                ...
                <div className="col-span-2 text-right text-xs font-bold text-neutral-700 uppercase tracking-wider">Actions</div>
            </div>
                    ...
                    {rows.map((r, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`grid grid-cols-12 px-6 py-5 items-center transition-all duration-200 ${
                                    isTopThree 
                            ...
                            >
                                ...
                                {/* Time Remaining */}
                                <div className="col-span-2">
                                    <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg font-mono font-bold text-sm ${
                                        isCriticalTime 
                                ...
                                <div className="col-span-2 flex items-center justify-end gap-2">
                                    <button 
                                        onClick={() => onView(r)} 
                                        className="cursor-pointer px-4 py-2 rounded-lg border border-neutral-200 bg-white hover:bg-neutral-50 text-neutral-700 text-sm font-medium transition-all duration-200 hover:shadow-sm"
                                    >
                                        View
                                    </button>
                                    <button 
                                        onClick={() => onAccept(r)} 
                                        className="cursor-pointer px-4 py-2 rounded-lg bg-gradient-to-r from-neutral-900 to-neutral-800 hover:from-neutral-800 hover:to-neutral-700 text-white text-sm font-semibold transition-all duration-200 hover:shadow-lg transform hover:scale-105"
                                    >
                                        Accept
                                    </button>
                                </div>
